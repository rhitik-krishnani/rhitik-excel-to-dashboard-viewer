...
### INSTRUCTIONS ###
1. Pick the best chart type considering the relation between the USER QUERY and the DATA (JSON) provided to you.
2. Use Plotly.js — load via CDN script tag
3. Chart must include all the features following the best practises of data visualization.
4. Layout: It should be responsive and should be full screen size (IMPORTANT)
5. Ensure to keep a good focus on rounding of values in chart, legends, colour selection, font and size selection and other formatting aspects. 
...
# file_path = "sample_superstore_dataset.xls"
# file_path = "Nicolau Syndrome_Step_5.xlsx"
file_path = os.getenv("FILE_PATH")
print(f"Step 1 ---> Read file path that is , {file_path}")
# user_query = "What is count of report ids per country ??"
